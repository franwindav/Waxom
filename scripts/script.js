...
$("#sliders").ready(function(){
	if(window.screen.width <= 370) $("#width").attr("content", "width=370, user-scalable=no, initial-scale=1");
	else $("#width").attr("content", "width=device-width, user-scalable=no, initial-scale=1");
	bindSlider();
	resizeSliders();
	...
	function resizeSliders(){
		if(window.screen.width <= 400) $("#width").attr("content", "width=370, user-scalable=no, initial-scale=1");
		else $("#width").attr("content", "width=device-width, user-scalable=no, initial-scale=1");
